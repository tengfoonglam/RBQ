...
print_help() {
    ...
    echo "  --sim_device DEV    set simulation device (e.g. cuda:0, cpu)"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --sim_device) CMD_ARGS+=(" $1 $2"); shift 2 ;;
...
CMD="$SCRIPTS_DIR/python.bash $GYM_DIR/$PACKAGE_NAME/play.py ${CMD_ARGS[@]}"
bash $CMD 

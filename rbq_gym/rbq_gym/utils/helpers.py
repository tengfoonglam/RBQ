...
from rbq_gym import GYM_ROOT_DIR, GYM_ENVS_DIR
...
def get_args():
    custom_parameters = [
        {"name": "--task", "type": str, "default": "rbq10_jhb", "help": "Resume training or start testing from a checkpoint. Overrides config file if provided."},
        ...
        {"name": "--tracking_camera", "action": "store_true", "default": False, "help": "camera move for tracking robot[0]" },

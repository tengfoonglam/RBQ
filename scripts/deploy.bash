...
if [ ${#SELECTED_BINARIES[@]} -eq 0 ]; then
    ...
    SCRIPT_FILES=("RBQ.bash" "start_motion.bash" "start_vision.bash" "start_mediamtx.bash" "start_vpn.bash" "start_ros_driver.bash" "start_slam.bash" "sim.bash" "start_mujoco.bash")
